...
export default function NotFound() {
  return (
    <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-5 py-24 text-center sm:px-8">
      <p className="font-mono text-xs uppercase tracking-widest text-primary-600">404</p>
      ...
      <Link
        to="/"
        className="mt-2 rounded-full bg-ink px-5 py-2 font-mono text-xs uppercase tracking-widest text-paper transition hover:bg-primary-600"
      >
        Back to all stays
      </Link>
    </div>
